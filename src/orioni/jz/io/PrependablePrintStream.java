...
/**
 * This extension of {@link PrintStream} allows the user to specify a tag which will be prepended to every line
 * written to this {@link PrintStream}.  Additionally, the number of times this tag will be prepended can also be
 * specified.
...
// NON-STATIC FIELDS /////////////////////////////////////////////////////////////
    ...
    protected ArrayList prependStrings;
...
// OVERRIDDEN PRINTSTREAM METHODS ////////////////////////////////////////////////
    ...
    public synchronized void write(byte[] buf, int off, int len)
    {
        ...
        {
            int length = 0;
            while ((starting + length < off + len) &&
                    ((length == 0) ||
                    (buf[starting + length - 1] != '\n')))
                length++;
